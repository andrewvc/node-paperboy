...
exports.streamFile = function (filepath, headerFields, stat, res, req, emitter) {
  ...
  process.nextTick( function() {
    ...
    if (statCode == 304) {
      ...
      //the buffer size and chunk size. However, this could use some more
      //benchmarking, so I'm going to leave the code that handles using
      //a separate buf size from chunk size in place in case someone else
      //wants to test this out on larger files.
